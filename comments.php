...
<section id="respond">
	<h6><?php comment_form_title( __('Leave a Reply', 'FoundationPress'), __('Leave a Reply ke %s', 'FoundationPress') ); ?></h6>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<?php else : ?>
		<p>
			<label for="author"><?php _e('Nama', 'FoundationPress'); if ($req) _e(' *', 'FoundationPress'); ?></label>
			<input type="text" class="five" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?>>
		</p>
		<p>
			<label for="email"><?php _e('Email', 'FoundationPress'); if ($req) _e(' *', 'FoundationPress'); ?></label>
			<input type="text" class="five" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?>>
		</p>
		
		<?php endif; ?>
		<p>
			<label for="comment"><?php _e('Komentar', 'FoundationPress'); ?></label>
